...
| published-package-seam | 6 | 1 | no | first non-systemic P1 | Record and categorize like a first ordinary finding and add a regression test where practical. | regression test |
