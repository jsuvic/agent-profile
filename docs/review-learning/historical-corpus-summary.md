...
| --- | ---: | ---: | --- | --- | --- | --- |
| ownership-atomicity | 37 | 3 | yes | third occurrence | Add a test, lint, validator, or shared helper where practical; the prompt rule alone has proven insufficient. | regression test, scoped rule, mechanical guard or recorded impracticality |
| cross-consumer-integration | 19 | 3 | no | third occurrence | Add a test, lint, validator, or shared helper where practical; the prompt rule alone has proven insufficient. | regression test, scoped rule, mechanical guard or recorded impracticality |
| parser-version-contract | 7 | 5 | no | third occurrence | Add a test, lint, validator, or shared helper where practical; the prompt rule alone has proven insufficient. | regression test, scoped rule, mechanical guard or recorded impracticality |
| state-classification | 30 | 4 | no | third occurrence | Add a test, lint, validator, or shared helper where practical; the prompt rule alone has proven insufficient. | regression test, scoped rule, mechanical guard or recorded impracticality |
| preview-before-write-ordering | 7 | 3 | no | third occurrence | Add a test, lint, validator, or shared helper where practical; the prompt rule alone has proven insufficient. | regression test, scoped rule, mechanical guard or recorded impracticality |
